...
<section class="head head-img" id="careers" data-speed="2" data-type="background">
    <div class="container">
		<div class="row">
...
<div class="container">
    ...
    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
      ...
      <div id="my-tab-content" class="tab-content">
        <div class="tab-pane fade in active" id="2015">
    
        	<h3>2015 Full Time &amp; Internships</h3>
        ...
        <div class="tab-pane fade" id="2014">
            ...
            <h3>2014 Full Time &amp; Internships</h3>
            <div class="table-responsive">
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Philmon Tanuri</td>
                        <td>Accenture</td>
                        <td>Consulting Analyst Intern</td>
                        <td>Jakarta, Indonesia</td>
                    </tr>
                    <tr>
                        <td>Melissa Zhang</td>
                        <td>Pacific Investment Management Company (PIMCO)</td>
